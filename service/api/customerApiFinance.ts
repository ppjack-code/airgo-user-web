...
export async function postCustomerFinanceGetBalanceStatementList(
  ...
  return request<API.ResponseStruct>(
...
export async function getCustomerFinanceGetCommissionSummary(options?: {
  [key: string]: any;
}) {
  return request<API.ResponseStruct>(
...
export async function getCustomerFinanceWithdrawToBalance(options?: {
  [key: string]: any;
}) {
  return request<API.ResponseStruct>(
